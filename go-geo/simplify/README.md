...
This package implements several reducing/simplifing function for `geom.Geometry` types.
...
Usage:
	...
	original := geom.NewLineString(geom.XY)
...
Usage:
	...
	original := geom.NewLinearRing(geom.XY)
