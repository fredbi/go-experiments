...
func TestNewTile(t *testing.T) {
	...
	fn := func(t *testing.T, tc tcase) {
		...
		tile := newTile(tc.z, tc.x, tc.y, tc.buffer, tc.srid)
		{
			gz, gx, gy := tile.ZXY()
			if gz != tc.z {
		...
		}
		{
			bounds := tile.Bounds()
			for i := 0; i < 4; i++ {
				if !cmp.Float64(bounds[i], tc.eBounds[i], 0.01, math.MaxInt64) {
...
// 		// Test the new functions.
// 		tile := NewTileLatLon(tc.z, tc.lat, tc.lon, tc.buffer, tc.srid)
// 		{
// 			gz, gx, gy := tile.ZXY()
// 			if gz != tc.z {
// 				t.Errorf("z, expected %v got %v", tc.z, gz)
...
// 	}{
// 		"children 1": {
// 			tile:   NewTile(0, 0, 0, 0, WebMercator),
// 			zoomAt: 1,
// 			expected: []coord{
// 				{1, 0, 0},
// 				{1, 0, 1},
...
// 		},
// 		"children 2": {
// 			tile:   NewTile(8, 3, 5, 0, WebMercator),
// 			zoomAt: 10,
// 			expected: []coord{
// 				{10, 12, 20},
// 				{10, 12, 21},
...
// 		},
// 		"parent 1": {
// 			tile:   NewTile(1, 0, 0, 0, WebMercator),
// 			zoomAt: 0,
// 			expected: []coord{
// 				{0, 0, 0},
// 			},
// 		},
// 		"parent 2": {
// 			tile:   NewTile(3, 3, 5, 0, WebMercator),
// 			zoomAt: 1,
// 			expected: []coord{
// 				{1, 0, 1},
// 			},
...
// 		tc.tile.RangeFamilyAt(tc.zoomAt, func(tile *Tile) error {
// 			z, x, y := tile.ZXY()
// 			c := coord{z, x, y}
